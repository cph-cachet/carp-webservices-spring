...
class CollectionControllerTest {
    ...
    inner class Create {
        ...
        @Test
        fun `should return 400 if studyId is not a valid UUID`() = runTest {
    ...
    inner class GetByStudyIdAndCollectionId {
        @Test
        fun `should return 200 if collection exists`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
    ...
    inner class GetAll() {
        @Test
        fun `should return the collection of collection if query is not specified`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
            val url = "/api/studies/${mockStudyId}/collections"
        ...
        @Test
        fun `should return the collection of collection if query is specified`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
            val query = "someQuery"
    ...
    inner class GetByStudyIdAndDeploymentId() {
        @Test
        fun `should return the collection of collection if url is correct`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
        ...
        @Test
        fun `should return 400 if deploymentId is not UUID`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
    ...
    inner class Delete() {
        @Test
        fun `should return 200 if collection is deleted`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
            val mockCollectionId = 1
            val url = "/api/studies/${mockStudyId}/collections/id/${mockCollectionId}"
        ...
        @Test
        fun `should return 400 if collectionId is not an integer`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
    ...
    inner class Update() {
        @Test
        fun `should return 400 if body is not valid`() = runTest {
            val mockStudyId = UUID.randomUUID().stringRepresentation
            val mockCollectionId = 1
            val url = "/api/studies/${mockStudyId}/collections/id/${mockCollectionId}"
