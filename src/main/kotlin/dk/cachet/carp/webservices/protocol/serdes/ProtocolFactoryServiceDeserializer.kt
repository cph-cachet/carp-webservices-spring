    ...
    override fun deserialize(
        ...
        try {
            ...
            throw SerializationException(
                validationMessages.get("protocol.factory.deserialization.bad_format", ex.message.toString()),
            )
        }
        ...
        try {
            ...
            throw SerializationException(
                validationMessages.get("protocol.factory.deserialization.error", ex.message.toString()),
            )
        }
