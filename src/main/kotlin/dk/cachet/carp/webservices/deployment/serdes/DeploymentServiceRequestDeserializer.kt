 ...
 */
class DeploymentServiceRequestDeserializer(private val validationMessages: MessageBase): JsonDeserializer<DeploymentServiceRequest<*>>()
{
    companion object
    {
     ...
     */
    override fun deserialize(jsonParser: JsonParser?, deserializationContext: DeserializationContext?): DeploymentServiceRequest<*>
    {
        ...
        catch (ex: Exception)
        {
            ...
            throw SerializationException(validationMessages.get("deployment.deserialization.bad_format", ex.message.toString()))
        }
        ...
        catch (ex: Exception)
        {
            ...
            throw SerializationException(validationMessages.get("deployment.deserialization.error", ex.message.toString()))
        }
