...
interface DataStreamSequenceRepository: JpaRepository<DataStreamSequence, Int>
{
    ...
    fun findAllByDeploymentIds(@Param("deploymentIds") deploymentIds: List<String>): List<DataStreamSequence>
    ...
    fun findAllByDataStreamId(@Param("dataStreamId") dataStreamId: Int): List<DataStreamSequence>
