...
class OpenApi30Config(
    ...
    private fun generateAdditionalSchemasForOpenApi(openAPI: OpenAPI) {
        ...
        openAPI.components.addSchemas(
            ...
            Schema<Any>().apply {
                type = "object"
                description = "KSerializer<StudyProtocolSnapshot>"
            },
        )
        openAPI.components.addSchemas(
            ...
            Schema<Any>().apply {
                type = "object"
                description = "KSerializer<List<StudyProtocolSnapshot>>"
            },
        )
        openAPI.components.addSchemas(
            ...
            Schema<Any>().apply {
                type = "object"
                description = "KSerializer<List<ProtocolVersion>>"
            },
        )
    }
}
