...
{
    fun findByStudyIdAndCreatedBy(studyId: String, createdBy: String): List<File>
...
interface FileRepositoryCustom
{
     ...
     */
    fun save(studyId: String, uploadedFile: MultipartFile, fileName: String, metadata: JsonNode?): File
}

@Repository
class FileRepositoryImpl(@Lazy private val fileRepository: FileRepository): FileRepositoryCustom
{
    /**
     ...
     * @param fileName The [fileName] of the file.
     */
    override fun save(studyId: String, uploadedFile: MultipartFile, fileName: String, metadata: JsonNode?): File
    {
        val file = File(studyId = studyId, storageName = fileName, originalName = uploadedFile.originalFilename!!, metadata = metadata)
