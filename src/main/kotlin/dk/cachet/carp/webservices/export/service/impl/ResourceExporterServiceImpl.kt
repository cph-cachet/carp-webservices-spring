...
): ResourceExporterService
{
    ...
    override suspend fun exportStudyData( studyId: UUID, deploymentIds: Set<UUID>?, targetDir: Path, log: ExportLog )
    {
    ...
    override fun exportCSV( header: String, rows: List<String>, path: Path, log: ExportLog )
    {
    ...
    private fun exportLogAsFile( log: ExportLog, rootFolder: Path )
    {
    ...
    private fun writeResourceAsJson( path: Path, resource: Any, log: ExportLog )
    {
        try
        {
